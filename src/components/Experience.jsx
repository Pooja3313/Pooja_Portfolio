...
const Experience = () => {
  ...
  const experiences = [
    {
      title: " Associate Full-Stack Developer (MERN)",
      company: "E2logy Software Solutions Pvt. Ltd.",
      location: "Ahmedabad, Gujarat",
      duration: "2025",
      type: "Full-time",
      description:
        "Working on full-stack MERN applications with modern development practices and agile methodologies.",
      responsibilities: [
        "Build high-performance web applications using MERN stack technologies",
        "Create clean, reusable, and user-friendly UI components",
        "Manage and structure database models for efficient data flow",
        "Work closely with product, design, and QA teams to deliver features on time",
      ],
      skills: [
        "React.js",
        "Node.js",
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Focused on frontend development using React.js and modern JavaScript frameworks.",
      responsibilities: [
    ...
    },
    {
      ...
      type: "Internship",
      description:
        "Worked on industrial MERN stack project, gaining hands-on experience with full-stack development.",
      responsibilities: [
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            My professional journey in software development and MERN stack
            technologies
          </p>
        </motion.div>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div
                  ...
                  } transform md:translate-x-1/2 w-4 h-4 bg-gradient-to-r ${
                    exp.color
                  } rounded-full border-4 border-white shadow-lg z-10 md:top-8`}
                ></div>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center space-x-3">
                      <div
                        className={`p-3 bg-gradient-to-r ${exp.color} text-white rounded-lg`}
                      >
                        <exp.icon size={24} />
                      </div>
                      <div>
